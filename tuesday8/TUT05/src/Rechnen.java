...
public class Rechnen {
	...
	*/
	...
	/**
	* Returns a new Bruchzahl object that is the result of an addition between Bruchzahl objects a and b.
	*/
	public static Bruchzahl add(Bruchzahl a, Bruchzahl b) {
		Bruchzahl result = new Bruchzahl(a.zaehler* b.nenner + b.zaehler*a.nenner, a.nenner * b.nenner);
		result = result.kuerzen();
		return result;
	}
	
	/**
	* Returns a new Bruchzahl object that is the result of an subtraction between Bruchzahl objects a and b.
	*/
